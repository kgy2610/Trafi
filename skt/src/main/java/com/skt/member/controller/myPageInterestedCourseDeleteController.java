...
public class myPageInterestedCourseDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public myPageInterestedCourseDeleteController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Interested interested = new Interested(loginValue, courseNo, 0, 0);
		
		MemberService memberService = new MemberServiceImpl();
		int result = memberService.deleteInterestedCourse(interested);
